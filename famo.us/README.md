...
[![Build Status](https://travis-ci.org/tiansivive/famoustravel.svg?branch=master)](https://travis-ci.org/tiansivive/famoustravel) [![Dependency Status](https://david-dm.org/tiansivive/famoustravel.svg)](https://david-dm.org/tiansivive/famoustravel) [![devDependency Status](https://david-dm.org/tiansivive/famoustravel/dev-status.svg)](https://david-dm.org/tiansivive/famoustravel#info=devDependencies)
...
## Release History
 * 2014-09-24   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)